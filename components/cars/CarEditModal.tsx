    ...
    <Modal open={open} onClose={onClose} title="Editează vânzarea"
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="sale-date" className="text-xs font-semibold uppercase tracking-wide text-slate-600">Data vânzării</label>
          <input id="sale-date" type="date" value={form.saleDate} onChange={(e) => setF("saleDate", e.target.value)}
