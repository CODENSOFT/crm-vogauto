  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <>
        {/* Telefon / tabletă: carduri (editarea se face în pagina vânzării) */}
        <div className="space-y-3 lg:hidden">
          {cars.length === 0 ? (
            <div className="rounded-xl border border-dashed border-slate-300 bg-white py-14 text-center text-slate-400">Nicio vânzare găsită.</div>
          ) : cars.map((car) => (
              ...
              <div className="flex gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-xs">
                    ...
                    <span className="text-slate-500">Profit: <b className={Number(car.priceSell) - Number(car.priceBuy) >= 0 ? "text-emerald-700" : "text-red-600"}>{formatMoney(Number(car.priceSell) - Number(car.priceBuy))}</b></span>
                  </div>
        ...
        {/* Desktop: tabel cu editare în linie */}
